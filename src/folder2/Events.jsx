...
function Events() {
    ...
    // 매개변수로 이벤트 핸들러(객체)를 사용하는 함수를 클릭 이벤트와 연동
    const click3 = (item, event) => {
        let msg = `매개변수와 event 객체가 있는 클릭이벤트
    ...
    return (
        <div>
            ...
            <button type={"button"} className={"btn btn-warning"} onClick={() => click2(100)}>매개변수가 있는 클릭 이벤트</button>
