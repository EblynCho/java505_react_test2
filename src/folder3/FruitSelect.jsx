...
function FruitSelect(props) {
    ...
    const handleSubmit = (e) => {
        alert(`선택한 과일 : ${value}, 다중 선택한 과일 : ${value2}`);
        e.preventDefault();
    }
    ...
    return (
        <form onSubmit={handleSubmit}>
            <div className={"my-3"}>
                ...
                {/* 리액트에서 기본 html 의 속성 중 속성명으로만 효과가 발생하는 속성에 대해서도 값을 제어하기 위해서 속성명={값} 형식으로 사용함 (ex. disabled={true}) */}
