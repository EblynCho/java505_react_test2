...
function DailyBoxOffice(props) {
    ...
    // 문제1) 버튼 클릭 시 axios 통신을 통해서 데이터를 가져와서 화면의 table에 출력하는 컴포넌트를 작성하세요
    // state 사용, map() 사용

    // boxOffice 를 state 로 설정, 초기값이 빈 배열
            ...
            <div className={'row'}>
                <div className={'col-sm-8 mx-auto'}>
                    ...
                    <div className={'my-3 d-flex justify-content-end'}>
                        <button className={'btn btn-outline-primary'} onClick={loadBoxOffice}>어제 영화 순위 조회</button>
                    </div>
                </div>
            </div>
        </div>
